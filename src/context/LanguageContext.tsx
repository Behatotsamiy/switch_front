...
export const translations = {
  ru: {
    nav: { events: 'Мероприятия', community: 'Сообщество', projects: 'Проекты', mentors: 'Менторы', about: 'О нас', login: 'Войти', signup: 'Регистрация' },
    landing: {
      heroTitle1: 'Расширяем возможности девушек.',
      heroTitle2: 'Строим будущее.',
      heroDesc: 'SWITCH — это сообщество для девушек, которые хотят учиться, создавать и запускать стартап-проекты.',
      joinBtn: 'Присоединиться',
      eventsBtn: 'Мероприятия',
      stats: { members: 'Участниц', events: 'Мероприятий', projects: 'Проектов', mentors: 'Менторов' },
  ...
  uz: {
    nav: { events: 'Tadbirlar', community: 'Hamjamiyat', projects: 'Loyihalar', mentors: 'Mentorlar', about: 'Biz haqimizda', login: 'Kirish', signup: "Ro'yxatdan o'tish" },
    landing: {
      heroTitle1: 'Qizlar imkoniyatlarini kengaytiramiz.',
      heroTitle2: 'Kelajakni barpo etamiz.',
      heroDesc: "SWITCH — bu o'rganish, yaratish va startap loyihalarni yo'lga qo'yishni xohlaydigan qizlar hamjamiyati.",
      joinBtn: "Hamjamiyatga qo'shilish",
      eventsBtn: 'Kutilayotgan tadbirlar',
      stats: { members: "A'zolar", events: 'Tadbirlar', projects: 'Loyihalar', mentors: 'Mentorlar' },
    ...
    auth: {
      ...
      registerSubtitle: "Hisob yarating va o'z startaplaringizni rivojlantiring",
      email: 'Email manzili',
      password: 'Parol',
      firstName: 'Ism',
      lastName: 'Familiya',
  ...
  en: {
    nav: { events: 'Events', community: 'Community', projects: 'Projects', mentors: 'Mentors', about: 'About', login: 'Log In', signup: 'Sign Up' },
    landing: {
      heroTitle1: 'Empowering Girls.',
      heroTitle2: 'Building Futures.',
      heroDesc: 'SWITCH is a community for girls who want to learn, build, and launch startup projects.',
      joinBtn: 'Join Community',
      eventsBtn: 'Upcoming Events',
      stats: { members: 'Members', events: 'Events', projects: 'Projects', mentors: 'Mentors' },
